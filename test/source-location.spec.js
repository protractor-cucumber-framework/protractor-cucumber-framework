...
describe('source locations', function() {
  it('cucumber 1 provides source locations to protractor', function() {
    return util.runOne('test/cucumber/conf/cucumber1Conf.js --cucumberOpts.tags @sourceLocation')
      .expectExitCode(0)
      .expectEvents([{
  ...
  it('cucumber 2 provides source locations to protractor', function() {
    return util.runOne('test/cucumber/conf/cucumber2Conf.js --cucumberOpts.tags @cucumber2')
      .cucumberVersion2()
      .expectExitCode(0)
      .expectEvents([{
        emitterEvent: 'testPass',
